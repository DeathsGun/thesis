...
%-----------------------------------
% Zeichnungen im Fließtext
%-----------------------------------
% Muss nach xcolor stehen, da tikz xcolor selbst nachlädt und das
% sonst mit der hier gesetzten Option [table] kollidiert.
\usepackage{tikz}
\usetikzlibrary{fit,positioning,backgrounds}
% Eigene Zeichenebenen, damit umschließende Kästen die inneren nicht überdecken.
\pgfdeclarelayer{lproc}\pgfdeclarelayer{lpod}\pgfdeclarelayer{lnode}
\pgfsetlayers{lnode,lpod,lproc,main}
...
\printbibliography[nottype=misc,heading=bibintoc,title={\langde{Literaturverzeichnis}\langen{Bibliography}}]
...
\printbibliography[type=misc,heading=subbibliography,title={\headingNameInternetSources}]
